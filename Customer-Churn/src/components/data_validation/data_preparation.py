...
class DataPreparation:
    ...
    def prepare_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            plt.tight_layout()
            plt.show()
            plt.savefig(r"D:\Ml-Projects\Customer-Churn\graphs\numerical.png")
            plt.close()
            ...
            plt.show()
            plt.savefig(r"D:\Ml-Projects\Customer-Churn\graphs\Boxplots.png")
            plt.close()
            ...
            plt.show()
            plt.savefig(r"D:\Ml-Projects\Customer-Churn\graphs\Distribution.png")
            plt.close()
